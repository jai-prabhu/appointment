                    ...
                    <div className="grid grid-cols-2 justify-center gap-8">
                            ...
                            <CardContent className="flex gap-4 items-center">
                                ...
                                <div className="">
                                    <h5 className="inline-flex gap-4 items-center text-slate-900 font-bold">
                                        { appointment?.doc.user.firstName + " " + appointment?.doc.user.lastName }
                        ...
                        <div className="grid grid-cols-2 w-full justidy-center gap-8 col-span-2">
                            ...
                            onClick={async () => {
                                ...
                                const res = await fetch(`${apiURL}/data/appointment-query/appointments/update/${params.appointment_id}`, {
                                    ...
                                    body: JSON.stringify(
                                        {
                                            dateTime: parse(selectedTime, "hh:mm a", new Date(date)).toISOString()
                                        }
                                    )
                                });
