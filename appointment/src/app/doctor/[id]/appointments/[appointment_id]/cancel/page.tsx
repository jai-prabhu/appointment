            ...
            <header className="sticky top-0 w-full bg-slate-50 border-b boder-slate-30 shadow-md shadow-slate-30 z-20">
                <div className="container mx-auto py-4">
                    <div className="flex items-center w-full gap-4">
                        ...
                        className="inline-flex gap-4 items-center justify-center text-slate-700 text-sm
                    ...
                    <div className="flex flex-col gap-8 items-center">
                        <CardHolder>
                            ...
                            <CardContent className="flex items-center justify-start gap-2">
                                ...
                                <div className="">
                                    <h5 className="text-slate-900 font-semibold text-lg">{appointment?.user.firstName + " " + appointment?.user.lastName}</h5>

                                    <p className="text-slate-500 text-sm">{appointment?.doc.specialization}</p>

                                    <div className="grid grid-cols-3 w-full">
                                        <p className="inline-flex items-center gap-2 text-sm text-slate-500 py-2">
